...
- [x] 1-1: 난이도/최대턴수/rubric (백엔드) (담당: cl-o-lc)
- [x] 1-2: 전공계열별 페르소나 (백엔드) (담당: cl-o-lc)
- [x] 1-3: 난이도/계열 프론트 연동 (담당: cl-o-lc)
- [x] 2-1: STT 용어사전 보정 (담당: cl-o-lc)
- [x] 2-2: 마이크 권한 에러 UX (담당: cl-o-lc)
- [x] 3-1: PPT 추출 백엔드 (담당: cl-o-lc)
- [x] 3-2: PPT 업로드 프론트 연동 (담당: cl-o-lc)
- [ ] 3-3: 슬라이드별 구체적 누락 피드백 (담당: )
- [x] 4-1: 세션 저장 유틸 (담당: cl-o-lc)
